...
console.log(text); // Should print `0 1 2 3 4 `.
...
console.log(text); // Should print `5 10 15 20 25 30 35 40 45 50 `.
...
text = '';
while (true) {
  randNum = Math.floor(Math.random() * (10-0+1)) + 0;
  if (randNum === 8) {
    break;
  }
  else {
...
console.log(text); // Should print something like `4 7 2 9 8 `, or `9 0 8 ` or `8 `.
